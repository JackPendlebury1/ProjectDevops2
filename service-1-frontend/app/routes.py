...
def home():
    ...
    if request.method == 'POST':
        char = requests.get("http://service2:5001/get_chargen")
        num = requests.get("http://service3:5002/get_numgen")
        prize = requests.post("http://service4:5003/get_prize", json={"account_number" : char.text + num.text})
